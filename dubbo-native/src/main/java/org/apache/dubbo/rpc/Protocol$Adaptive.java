...
public class Protocol$Adaptive implements org.apache.dubbo.rpc.Protocol {
    ...
    public org.apache.dubbo.rpc.Exporter export(org.apache.dubbo.rpc.Invoker arg0) throws org.apache.dubbo.rpc.RpcException {
        ...
        /**
         * Dubbo 会使用动态编译技术为接口Protocol生成一个适配器类 Protocol$Adaptive 对象的实例，在Dubbo框架中需要使用Protocol实例使
         * 实际上就是使用Protocol$Adaptive的对象实例来获取具体的spi实现类
         *
         * 下面的方法根据url中的参数 使用Dubbo增强SPI方法getExtension获取对应的SPI实现类。
         * 适配器类Protocol$Adaptive 会根据传递 的协议参数的不同加载不同的Protocol的SPI实现。
         *
         * =====
         * getExtension方法 实际获取到的是被使用Wrapper类增强后的实现类。
         */
